...
plotmeans(Time ~ Frequency, main = "Main Effect Plot for Ad Frequency", xlab = "Ad Frequency", ylab = "Mean Session Duration (min)", pch = 16)
...
model.full <- model
model.red <- lm(Time ~ Frequency + Type)
