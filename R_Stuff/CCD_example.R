...
## The data correspond to a CCD on two factors with axial conditions based on a = sqrt(2)
...
##   x2: Discount duration (days): 2  vs 5
...
## Thus, it seems like a promotional offer associated with a 50% discount offered for 2-day results in an
